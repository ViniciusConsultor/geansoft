...
namespace Gean.Library.UI.SudokuPanel
{
    /// <summary>
    ...
    public class SudokuPanel : Control
    {
        ...
        internal DoTable DoTable
        {
            get { return _DoTable; }
        }
        private DoTable _DoTable;
        ...
        {
            int[] doArrary = DoHelper.GetDoIntArrary(doString);
            int r = 0;
            int c = 0;
