...
namespace Gean.Data
{
    ...
    {
        public abstract DynamicQuery CreateDynamicQuery(BaseEntity entity);
        public abstract IDbCommand CreateIDbCommand();
        public abstract IDbDataAdapter CreateIDbDataAdapter();
        public abstract IDbConnection CreateIDbConnection();
        public abstract IDataParameter CreateIDataParameter(string name, object value);
        public abstract IDataParameter CreateIDataParameter();
        public abstract DbDataAdapter ConvertIDbDataAdapter(IDbDataAdapter dataAdapter);
        ...
        /// <returns></returns>
        internal virtual IDbCommand _LoadFromRawSql(string rawSql, params object[] parameters)
        {
            return null;
        }
        ...
        static public string DefaultConnectionStringConfig
        {
            get
            {
                return BaseEntity._defaultConfig;
            }
            set
            {
                BaseEntity._defaultConfig = value;
            }
        }
        ...
        virtual public void Save()
        {
            ...
            try
            {
                ...
                if (needToInsert || needToUpdate || needToDelete)
                {
                    ...
                    if (txCount > 1) txMgr.AddBaseEntity(this);
        ...
        internal string _config = BaseEntity._defaultConfig;
