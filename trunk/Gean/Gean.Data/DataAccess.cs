...
namespace Gean.Data
{
    ...
    abstract public class DataAccess
    {
        ...
        static private Enums.DbProvider _provider;
        /// <summary>
        /// 获取连接字符串
        /// </summary>
        ...
        /// </summary>
        static public Enums.DbProvider Provider
        {
            get
            {
                return _provider;
        ...
        static public DataAccess Create()
        {
            switch (Provider)
            {
                case Enums.DbProvider.OleDb:
                    return new OleDbDataAccess(ConnectionString);

                case Enums.DbProvider.SqlClient:
        ...
        static public void Initialize(Enums.DbProvider provider, string dataSource, string initialCatalog, string user, string password)
        {
            _provider = provider;
            switch (provider)
            {
        ...
        static public void Initialize(Enums.DbProvider provider, string connectionString)
        {
            _provider = provider;
