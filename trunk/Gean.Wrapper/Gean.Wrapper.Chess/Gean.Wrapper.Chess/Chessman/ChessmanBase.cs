...
namespace Gean.Wrapper.Chess
{
    ...
    public abstract class ChessmanBase
    {
        ...
        /// </summary>
        public static readonly ChessmanBase Empty = null;

        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="type">棋子类型</param>
        internal ChessmanBase(Enums.ChessmanType type, Enums.ChessmanSide side)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            ChessmanBase man = obj as ChessmanBase;
        ...
        /// 简单工厂模式，创建不同类型的棋子类
        /// </summary>
        public static ChessmanBase Create
        ...
        public static bool IsNullOrEmpty(ChessmanBase chessman)
        {
            if (chessman == null)
                return true;
            if (chessman == ChessmanBase.Empty)
                return true;
            return false;
        }
