...
namespace Gean.Wrapper.Chess
{
    class PGNLex
    {
        ...
        public const int EOF_CHAR = '&';
        private const int TOKENSIZE = 49;

        public const int TT_NONE = 0;
        public const int TT_IDENTIFIER = 1;
        public const int TT_NUMBER = 2;
        public const int TT_SEPARATOR = 3;
        public const int TT_STRING = 4;
        public const int TT_OUTCOME = 5;
        public const int TT_OPEN_TAG = 6;
        public const int TT_CLOSE_TAG = 7;
        ...
        public PGNLex(FileStream stream)
        {
            this.stream = stream;
        ...
        private bool isRank(char ch)
        {
            return (ch >= '1' && ch <= '8');
        }

        private bool isFile(char ch)
        {
            return (ch >= 'a' && ch <= 'h');
        }

        private bool isPiece(char ch)
        {
            return
              ch == 'P' || ch == 'R' || ch == 'N' ||
              ch == 'B' || ch == 'Q' || ch == 'K';
