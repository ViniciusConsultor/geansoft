...
namespace Gean.Wrapper.Chess
{
    ...
    {
        private ChessPiece m_pieceParent = null;
        ...
        public Moves(ChessPiece pieceParent)
        {
        ...
        public void Add(int TurnNo, int LastMoveTurnNo, Enums.Action action, ChessPiece Piece, Square From, Square To, ChessPiece pieceCaptured, int pieceCapturedOrdinal, int Score)
        {
            m_colMoves.Add(new Move(TurnNo, LastMoveTurnNo, action, Piece, From, To, pieceCaptured, pieceCapturedOrdinal, Score));
        }
