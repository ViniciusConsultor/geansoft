    ...
    public class PdfDocument
    {
        ...
        public byte[] CreateXrefTable(long fileOffset, out int size)
        {
            ...
            try
            {
                ...
                SourceCodeCollection.OffsetArray.Sort();
                numTableEntries = (uint)SourceCodeCollection.OffsetArray.Count;
                table = string.Format("xref\r\n{0} {1}\r\n0000000000 65535 f\r\n", 0, numTableEntries);
                for (int entries = 1; entries < numTableEntries; entries++)
                {
                    ObjectList obj = (ObjectList)SourceCodeCollection.OffsetArray[entries];
        ...
        public byte[] GetTrailer(uint refRoot, uint refInfo, out int size)
        {
            ...
            try
            {
                ...
                ObjectList objList = (ObjectList)SourceCodeCollection.OffsetArray[0];
                ...
                SourceCodeCollection.OffsetArray = null;
