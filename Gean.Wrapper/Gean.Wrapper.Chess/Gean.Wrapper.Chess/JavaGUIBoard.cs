...
namespace Gean.Wrapper.Chess
{
    ...
    public class GUIBoard
    {
        ...
        public GUIBoard(ChessEditor chessEditor)
        {
            ...
            for (y = 0; y < 8; y++)
            {
                for (x = 0; x < 8; x++)
                {
                    guiBoard[x][y] = new GUISquare(chessEditor, this, x, y, "S");
                }
            }
        ...
        private bool badCoordinate(int x, int y)
        {
        ...
        private void displayPieceList(Array pieces)
        {
        ...
        private bool noPiece(int x, int y)
        {
            return getPieceType(x, y) == ' ';
        }

        private bool anyPieceFound(int x, int y)
        {
            return getPieceType(x, y) != ' ';
        }

        private bool opponentPiece(char pieceColor, int x, int y)
        {
        ...
        private bool friendlyPiece(char pieceColor, int x, int y)
        {
            if (badCoordinate(x, y))
                return false;
            return !noPiece(x, y) && getPieceColor(x, y) == pieceColor;
        ...
        private bool opponentPawn(char pieceColor, int x, int y)
        {
            if (badCoordinate(x, y))
                return false;
        ...
        private bool friendlyPawn(char pieceColor, int x, int y)
        {
            if (badCoordinate(x, y))
                return false;
            return (getPieceType(x, y) == 'P') && getPieceColor(x, y) == pieceColor;
        ...
        private bool isKing(int x, int y, char pieceColor)
        {
            if (badCoordinate(x, y))
                return false;
        ...
        private bool opponentKing(int x, int y, char pieceColor)
        {
            if (badCoordinate(x, y))
                return false;
            return (getPieceType(x, y) == 'K') && getPieceColor(x, y) != pieceColor;
        ...
        private bool friendlyKing(int x, int y, char pieceColor)
        {
            if (badCoordinate(x, y))
                return false;
            return (getPieceType(x, y) == 'K') && getPieceColor(x, y) == pieceColor;
        ...
        private bool friendlyPieceFound(
        ...
        private bool opponentPieceFound(
          int x, int y, char piece, char pieceColor)
        {
            if (badCoordinate(x, y))
                return false;
        ...
        private ArrayList multiplePawns(int sourceX, int destinationX, int destinationY, char pieceColor)
        {
        ...
        private bool legalKnightKingChoice(
          int sourceX, int sourceY, int destinationX, int destinationY,
          char pieceColor)
        {
        ...
        private bool interposeKnightKing(
          int x, int y, String piece, char pieceType, char pieceColor)
        {
            if (badCoordinate(x, y))
                return false;
        ...
        private ArrayList multipleKnights(
        ...
        private bool legalBishopRookBranchMove(
          int sourceX, int sourceY, int destinationX, int destinationY,
        ...
        private bool interposeBishopRook(
        ...
        private ArrayList multipleBishops(
        ...
        private ArrayList multipleRooks(
          int destinationX, int destinationY, char piece, char pieceColor)
        {
            ArrayList list = new LinkedList();
            SquareCoordinate squareCoordinate;
        ...
        private void append(ArrayList list1, ArrayList list2)
        {
            for (int i = 0; i < list2.size(); i++)
                list1.add(list2.get(i));
        }

        private ArrayList multipleQueens(
          int destinationX, int destinationY, char piece, char pieceColor)
        {
            ArrayList list1 =
        ...
        private ArrayList multipleKings(
          int destinationX, int destinationY, char piece, char pieceColor)
        {
            ArrayList list = new LinkedList();
        ...
        private ArrayList removePins(int destinationX, int destinationY, ArrayList list)
        {
            SquareCoordinate squareCoordinate;
            bool pinned;
        ...
        ArrayList removePins2(
          int destinationX, int destinationY, ArrayList list)
        {
        ...
        private SquareCoordinate selectOnePiece(
          int sourceX, int sourceY, int destinationX, int destinationY, ArrayList list)
        {
            ArrayList = removePins2(destinationX, destinationY, list);
        ...
        private SquareCoordinate selectStatus(
          ...
          int destinationX, int destinationY, ArrayList list)
        {
            ArrayList = removePins(destinationX, destinationY, list);
            int size = list.size();
            if (size == 1)
        ...
        private bool pawnCheck(int x, int y, char pieceColor)
        {
            if (pieceColor == 'W')
        ...
        public bool isCheck(char pieceColor)
        {
        ...
        private bool kingInterposed(int x, int y)
        {
        ...
        public bool isCheckmate(char moveColor)
        {
            char pieceColor;
    ...
    public class SquareCoordinate
    {
        ...
        public bool equals(SquareCoordinate squareCoordinate)
        {
            if (squareCoordinate == null)
                return false;
