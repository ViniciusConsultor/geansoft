...
namespace Gean.Wrapper.Chess
{
    ...
    public abstract class ChessPiece
    {
        ...
        /// </summary>
        public static readonly ChessPiece NullOrEmpty = null;

        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="type">棋子类型</param>
        internal ChessPiece(Enums.ChessmanType type, Enums.ChessmanSide side)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            ChessPiece man = obj as ChessPiece;
        ...
        public static bool IsNullOrEmpty(ChessPiece chessman)
        {
            if (chessman == null)
                return true;
            if (chessman == ChessPiece.NullOrEmpty)
                return true;
            return false;
        }
