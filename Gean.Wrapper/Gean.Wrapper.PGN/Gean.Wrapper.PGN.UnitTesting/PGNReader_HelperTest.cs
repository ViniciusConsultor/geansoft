...
namespace Gean.Wrapper.PGN.UnitTesting
{
    ...
    ///</summary>
    [TestClass()]
    public class PGNReader_HelperTest
    {
        #region MyRegion
        ...
        public void GetPGNsByTextReaderTest()
        {
            ...
            PGNRecord[] expected = null; // TODO: 初始化为适当的值
            PGNRecord[] actual;
            actual = PGNReader_Accessor.Helper.GetPGNsByTextReader(reader);
        ...
        {
            string line;
            PGNReader_Accessor.StringPair expected;
            PGNReader_Accessor.StringPair actual;

            line = "[Event \"Wch U16\"]\r\n";
            expected = new PGNReader_Accessor.StringPair("Event", "Wch U16");
            actual = PGNReader_Accessor.Helper.ParseLine(line);
            Assert.AreEqual(expected.Key, actual.Key);
            Assert.AreEqual(expected.Value, actual.Value);
            Assert.AreEqual(expected, actual);

            line = "Site \"Beijing\"";
            expected = new PGNReader_Accessor.StringPair("Site", "Beijing");
            actual = PGNReader_Accessor.Helper.ParseLine(line);
            Assert.AreEqual(expected.Key, actual.Key);
            Assert.AreEqual(expected.Value, actual.Value);
            Assert.AreEqual(expected, actual);
            ...
            line = "Date \"1993.??.??\"";
            expected = new PGNReader_Accessor.StringPair("Date", "1993.??.??");
            actual = PGNReader_Accessor.Helper.ParseLine(line);
            Assert.AreEqual(expected.Key, actual.Key);
            Assert.AreEqual(expected.Value, actual.Value);
            Assert.AreEqual(expected, actual);
            ...
            line = "Result \"1/2-1/2\"";
            expected = new PGNReader_Accessor.StringPair("Result", "1/2-1/2");
            actual = PGNReader_Accessor.Helper.ParseLine(line);
            Assert.AreEqual(expected.Key, actual.Key);
            Assert.AreEqual(expected.Value, actual.Value);
            Assert.AreEqual(expected, actual);
