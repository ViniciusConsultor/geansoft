...
namespace Pansoft.CQMS.Options
{
    ...
    /// 选项节点实现
    /// </summary>
    public abstract class UUOption : IOption
    {
        ...
        /// </summary>
        /// <returns></returns>
        protected abstract UUOption CreateOption();
        ...
        /// <returns>选项节</returns>
        protected virtual UUOption CreateOptionSetting(UUOption setting, bool deep)
        {
            UUOption newSetting = this.CreateOption();
        ...
        /// 包含此选项节的父选项节
        /// </summary>
        public virtual UUOption Parent
        {
        ...
        /// 如果设置时存在相同的节，则替换
        /// </remarks>
        public virtual UUOption this[string childSettingName]
        {
        ...
        /// 如果不存在，将返回null
        /// </remarks>
        public virtual UUOption this[int childSettingIndex]
        {
        ...
        public virtual UUOption[] GetChildSettings()
        {
        ...
        /// 如果有相同的选项节，则返回第一个选项节
        /// </remarks>
        public virtual UUOption GetChildSetting(string xpath)
        {
        ...
        /// "."表示当前选项节，".."表示上级选项节
        /// </remarks>
        public virtual UUOption GetChildSetting(params string[] settingName)
        {
            UUOption setting = this;
        ...
        /// <returns>选项节</returns>
        public virtual UUOption Clone(bool @readonly, bool deep)
        {
            UUOption setting = this.CreateOptionSetting(this, deep);
        ...
        public virtual UUOption Merge(UUOption setting)
        {
            ...
            foreach (UUOption optionSetting in setting.operatorSettings.Values)
            {
        ...
        protected static UUOption Compile(UUOption current, OptionCollection settings)
        {
                ...
                for (int i = 0; i < settings.Count; i++)
                {
                    ...
                    switch (setting.SettingOperator)
                    {
                        ...
                        case OptionOperatorEnum.Move:
                            UUOption moveSetting = currentSettings[setting.Name];
                            if (moveSetting != null)
                            {
        ...
        /// </summary>
        /// <returns>选项节</returns>
        public virtual UUOption GetRootSetting()
        {
            UUOption root = this;
